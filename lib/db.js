...
const TURSO_URL   = 'libsql://ksbets-arstandr.aws-us-east-2.turso.io'
const TURSO_TOKEN = 'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzY3NzkwMzYsImlkIjoiMDE5ZGIwNDgtNjYwMS03Njk2LWFmMTMtMjM5NzA1YzBmZTMzIiwicmlkIjoiZGRjMTJhNGUtOGI1MC00Y2Q1LTg0N2YtNWJiNmUwZmRiMmJkIn0.d9xpS4KlhB-3CzCY12znZ0-T8QPS7F66bQA52XnjRKUxoxzUw64DY-NNddAdgSt9i1dAK_yBJuHs2jftQVJUCA'
...
export async function migrate() {
  ...
  for (const stmt of stmts) {
    try {
      ...
      const isDupCol     = msg.includes('duplicate column name') || msg.includes('already exists')
      if (!isIdempotent && !(isAddColumn && isDupCol)) {
